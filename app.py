...
# --- Novo blueprint Colaborador para status online/offline ---
...
def create_app():
    ...
    # ===== Configuração JWT =====
    app.config["JWT_SECRET_KEY"] = SECRET_KEY  # chave para assinatura do token
    jwt = JWTManager(app)
    ...
    # Novo blueprint Colaborador (online/offline)
